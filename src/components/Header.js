...
const Header = props => {
    return (
        <Col xs={12} style={{ height: 80, width: '100%', position: 'fixed', top: 0, left: 0, marginBottom: 80 }}>
            ...
            <Row center="xs" middle="xs" style={{ marginTop: 10 }}>
                <h1 className="link"
                    style={{ fontSize: 18, margin: 0, padding: 0, color: props.activeView === 'transaction' ? 'goldenrod' : 'grey' }}
                ...
                <h1 className="link"
                    style={{ fontSize: 18, margin: 0, padding: 0, color: props.activeView === 'table' ? 'goldenrod' : 'grey' }}
                    onClick={ () => props.setActiveView('table') }>
                    table view
                </h1>
                <h1 style={{ fontSize: 20, margin: 0, padding: 0, color: 'grey', marginRight: 10, marginLeft: 10 }}>|</h1>
                <h1 className="link"
                    style={{ fontSize: 18, margin: 0, padding: 0, color: props.activeView === 'log' ? 'goldenrod' : 'grey' }}
